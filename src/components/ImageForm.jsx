...
const ImageForm = ({ setImage }) => {
  ...
  return (
    <div className="relative">
      {imageUploaded ? (
        <button onClick={handleEditPhoto} className="text-lg font-semibold text-lime-200 bg-purple-500 hover:bg-purple-600 px-6 py-3 rounded-lg shadow-md transition-all">
          Edit photo
        </button>
      ) : (
        <>
