...
function GuestProfile() {
  ...
  return (
    ...
    >
      {auth.user ? (
        <div className="flex flex-col justify-center items-center w-full max-w-lg p-6">
          <h1 className="text-5xl font-bold text-white text-center mb-6 drop-shadow-lg">
            Welcome, {auth.user.name}
          </h1>
          <div className="bg-black bg-opacity-60 rounded-lg shadow-lg p-6 w-full">
